...
@media (max-width: 992px){ .product { grid-template-columns: 1fr; } .product-gallery { grid-template-columns: 1fr; grid-template-areas: 'main' 'thumbs'; } .thumbs { flex-direction: row; max-height: unset; } .main-image img { height: auto; } }
</style>
@endpush
@section('content')
