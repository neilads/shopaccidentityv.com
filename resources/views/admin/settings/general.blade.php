                ...
                <div class="card-body">
                    <form action="{{ route('admin.settings.general.update') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Liên kết liên hệ Admin</label>
                                    <input type="text" name="contact_admin_url"
                                        class="form-control @error('contact_admin_url') is-invalid @enderror"
                                        value="{{ old('contact_admin_url', $configs['contact_admin_url']) }}" placeholder="Nhập URL Messenger hoặc Zalo">
                                    @error('contact_admin_url')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="facebook" class="form-control @error('facebook') is-invalid @enderror" value="{{ old('facebook', config_get('facebook')) }}" placeholder="https://facebook.com/ten-trang">
                                    @error('facebook')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="image-upload">
                                        <input type="file" name="site_logo"
                                            class="form-control @error('site_logo') is-invalid @enderror" accept="image/jpeg,image/png,image/jpg,image/gif,image/webp"
